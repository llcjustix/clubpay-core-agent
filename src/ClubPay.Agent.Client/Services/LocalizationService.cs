...
public sealed class LocalizationService : INotifyPropertyChanged
{
    ...
    private static readonly IReadOnlyDictionary<string, string> RussianStrings = new Dictionary<string, string>
    {
        ...
        ["OpenApplications"] = "Открытые приложения", ["GamesAndApps"] = "ИГРЫ И ПРИЛОЖЕНИЯ", ["Running"] = "запущено", ["ManageSessionOnPhone"] = "Продлить или завершить сеанс можно в ClubPay",
        ["Game"] = "Игра", ["Platform"] = "Платформа", ["Shooter"] = "Шутеры", ["Strategy"] = "Стратегии", ["Other"] = "Другое",
    ...
    private static readonly IReadOnlyDictionary<string, string> UzbekStrings = new Dictionary<string, string>
    {
        ...
        ["OpenApplications"] = "Ochiq ilovalar", ["GamesAndApps"] = "O'YINLAR VA DASTURLAR", ["Running"] = "ishga tushirilgan", ["ManageSessionOnPhone"] = "Seansni ClubPay ilovasida uzaytirish yoki yakunlash mumkin",
        ["Game"] = "O'yin", ["Platform"] = "Platforma", ["Shooter"] = "Otishma", ["Strategy"] = "Strategiyalar", ["Other"] = "Boshqa",
