...
3. Нажмите правой кнопкой на `install-manager.cmd` → **Запуск от имени администратора**.
   Вставьте одноразовый код **для резервного ПК менеджера** из Web Admin.
...
4. Войдите теми же данными, что в [web-админке](https://clubpay.justix.uz/admin).
